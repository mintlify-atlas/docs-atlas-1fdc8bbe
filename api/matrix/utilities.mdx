...
<Note>
  **MatrixPrint** is the only exported (public) function on this page. The other functions (`sigmoid`, `randomArray`) are internal helpers that cannot be called directly from your code.
</Note>
